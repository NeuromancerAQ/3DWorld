...
THREE.MeshLineMaterial = function (parameters) {
  ...
  let vec = new THREE.Vector2(1, 1)
  this.resolution = check(parameters.resolution, vec)
  ...
  vec = null
  var v = new THREE.Vector2(this.dashArray[0], this.dashArray[1])
